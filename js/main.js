;(function () {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    flipBox.addEventListener('mouseleave', function() {
      // Remove flipped class to reset flip animation
      flipBox.classList.remove('flipped');
    });
  
    // Add click event to the front text
    var frontText = document.querySelector('.flip-text');
    frontText.addEventListener('click', function(event) {
      event.stopPropagation(); // Prevents triggering flip when clicking the text
